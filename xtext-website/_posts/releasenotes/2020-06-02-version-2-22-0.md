...
Furthermore, the [Xtext Developer Documentation](https://github.com/eclipse/xtext/tree/master/dev-doc) has been extended by a step-by-step introduction on [How to regenerate the test- and production Xtext languages](https://github.com/eclipse/xtext/blob/master/dev-doc/RegenerateLanguages.md) to enable the community to easily contribute to Xtext.
